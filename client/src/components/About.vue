<template>
    <div class="relative flex flex-col-reverse py-16 lg:py-0 lg:flex-col">
     ...
     <div class="hidden md:block lg:block inset-y-0 top-0 right-0 w-full max-w-xl px-4 mx-auto mb-6 md:px-0 lg:pl-8 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-1/2 lg:max-w-full lg:absolute xl:px-0">
  <img class="rounded shadow-lg lg:rounded-none lg:shadow-none md:h-96 lg:h-full"
    src="https://img.freepik.com/free-photo/full-shot-flight-attendants-with-baggage_23-2150312752.jpg?t=st=1713791346~exp=1713794946~hmac=1be591f170f9ec9fc030f5127bcf5cc0e440f368a986676275bd1cc002565597&w=360"
    alt=""
  />
</div>
